This is the second part of the mini-series on Elixir macros. [Last time](macros_1) I discussed compilation phases and Elixir AST, finishing with a basic example of the `trace` macro. Today, I'll provide a bit more details on macro mechanics.
...
This concludes today's session. Many details are not covered, but hopefully you have a better understanding of how macros integrate with the Elixir compiler. In the [next part](macros_3) I'll dive deeper and start exploring how we can tear apart the input AST.